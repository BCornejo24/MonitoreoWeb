...
const cre_editAlm = (props) => {
    ...
    const [nCurso,setnCurso] = useState(false);
...
*/
        ...
        const recepcion = (linkObject,e) => {
            ...
            const b = await db.collection('G_Permisos').where('Nombre_G_Perm','==','Alumno').get()
